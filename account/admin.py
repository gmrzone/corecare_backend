...
class CustomUserAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        (_('Extra fields'), {'fields': ('username', 'email', 'first_name', 'last_name', 'photo')}),
        (_('Employment_Detail'), {'fields': ('employee_category', 'document','is_employee', 'is_verified_employee')}),
        (_('Address'), {'fields': ('address_1', 'address_2', 'city', 'state', 'pincode')}),
        (_('Permissions'), {'fields': ('verified' ,'is_staff', 'is_active', 'is_superuser', 'groups', 'user_permissions')}),
