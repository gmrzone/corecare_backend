...
urlpatterns = [
    path(
        "employee_category/", views.EmployeeCategoryList, name="employee_category_list"
    ),
    ...
    path(
        "subcategory/<int:id>/<slug:slug>/",
        views.get_subcategory_for_single_category,
        name="get_subcategory_for_single_category",
    ),
    ...
    path(
        "partner/request/", views.CreatePartnerRequest.as_view(), name="partner_request"
    ),
    ...
    path(
        "subcategory/v2/<int:id>/<slug:slug>/",
        views.GetSubcategoryForSingleCategory.as_view(),
        name="get_subcategory_for_single_category_new",
    ),
    path(
        "get_employee/v2/<slug:slug>/",
        views.GetEmployeesList.as_view(),
        name="get_employee_new",
    ),
    path(
        "get_services/v2/<slug:slug>/",
        views.GetFullServiceList.as_view(),
        name="get_full_service_new",
    ),
    path(
        "get_reviews/v2/<slug:slug>/",
        views.GetReviewsList.as_view(),
        name="get_reviews_new",
    ),
    path(
        "get_replies/v2/<int:parent_id>/",
        views.GetReplyForReview.as_view(),
        name="get_reply",
    ),
    path(
        "v2/category/hiring/",
        views.GetHiringEmployeeCategory.as_view(),
        name="hiring_category_new",
    ),
    path(
        "search/v2/<str:query>/<str:city>/",
        views.SearchServices.as_view(),
        name="search_service_new",
    ),
    path(
        "employee_category/v2/",
        views.EmployeeCategoryListView.as_view(),
        name="employee_category_list_new",
    ),
