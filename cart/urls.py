...
urlpatterns = [
    ...
    path(
        ...
        views.CreateRazorPayOrder.as_view(),
        name="create_rezorpay_order",
    ),
    path("create-orders/", views.create_order, name="create_order"),
    path(
        "services/get-recommandation/basic/",
        views.get_basic_recommandation,
        name="basic_recommandation",
    ),
    path(
        "services/get-recommandation/detail/",
        views.get_detailed_recommandation,
        name="detail_recommandation",
    ),
    path(
        "add/from_recommanded/",
        views.add_from_recommanded_toCart,
        name="add_from_recommanded",
    ),
    path(
        "order/invoice/generate/download/<str:order_id>/",
